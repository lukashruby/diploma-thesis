...
\label[2.buses]
\secc In-vehicle real-time buses
...
The first generation of On-Board Diagnostic requirements, called \glref{OBD} I, was developed by the California Air Resources Board (ARB) and implemented in 1988. As technological possibilities to expand On-Board Diagnostic capability increased, a second-generation of On-Board Diagnostics requirements was developed. This second version  is called \glref{OBDII}. The Clean Air Act Amendments of 1990\urlnote{http://www.epa.gov/clean-air-act-overview/1990-clean-air-act-amendment-summary} stated that, beginning with the 1996 model year, all light-duty vehicle and trucks made available for sale outside of the state of California must also be equipped with OBDII. In addition, EPA also requires that medium duty vehicles up to 6.5 tons must also be equipped with OBDII systems beginning in the 2004 model year~\cite[epa_obd]. In the last years, OBD systems are required by EPA to be installed on light-duty vehicles and trucks, as well as heavy-duty engines.

OBD plays an important role where vehicle inspection and maintenance programs are required. OBD serves as an early warning system that alerts to the potential need for vehicle repair through the {\em Check Engine} light on the dashboard of a vehicle~\cite[epa_obd].
...
\picw=8cm \cinspic resources/images/elm327.jpg

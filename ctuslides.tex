% ctuslides.tex -- the template for generating slides in CTUstyle design
% ----------------------------------------------------------------------
% Petr Olsak  Jun. 2015
...
\pdfximage width2cm {ctulogo.pdf}\mathchardef\logopic=\pdflastximage
\def\logobox{\vbox to0pt{
  \hbox{{\Blue\vrule width12pt height46pt}\kern5pt
...
\def\uniname{\kern10pt\typosize[10/11.3]\bf
   \vbox{\hsize=70pt\leftskip=0pt \rightskip=0pt minus10pt\def\nl{\hfil\break}\mtext{ctu}}%
   \if^\the\faculty^\else \kern15pt{\bf\thefontsize[35]\Blue \printfaculty}\kern10pt

...
Low fidelity prototypes are generally limited functions, limited interaction prototypes. They are constructed to depict concepts, design alternatives, and screen layouts. They are constructed quickly and provide limited or no functionality. These prototype are created to demonstrate the general look, they are not intended to show in detail how the application operates. They should communicate, educate, and inform, not to train, test, or serve as a basis from which to code~\cite[Rudd:1996:LVH:223500.223514].

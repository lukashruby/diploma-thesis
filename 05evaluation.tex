...
Table~\ref[lct_results] shows that in the object avoidance the tests were 100\% successful. However, the result with bigger group of participant could be different - for example in picture~\ref[lct_res4] in Appendix~\ref[tests_results] is obvious that object avoidance was very tight. 
